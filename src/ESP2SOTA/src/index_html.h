    ...
    "<div style='width:100%;text-align:center;font-size:18px;font-weight:bold;margin-bottom:12px;'>Aktualizacja</div>"
    ...
    "</div><div><span style='color: red;'>Nie wy&#x142;&#x105;czaj urz&#x105;dzenia i pami&#x119;taj, &#x17C;eby u&#x17C;ywa&#x107; tylko oryginalnego oprogramowania. Niezastosowanie si&#x119; grozi uszkodzeniem modu&#x142;u!</span></div>"
    "</div>"
    "</body>"
    "<script>"
    ...
    "form.addEventListener('submit', e=>{"
         ...
         "req.upload.addEventListener('progress', p=>{"
              ...
              "if(w == '100%') setTimeout(delayedFunction, 2000);" 
         "});"
         "req.send(data);"
     "});"
